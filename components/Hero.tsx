    ...
    return (
        <section className="relative min-h-screen flex items-center pt-28 overflow-hidden bg-white">
            ...
            <div className="absolute inset-0 z-0">
                ...
                >
                    <source src="/assetes/Dvideo.mp4" type="video/mp4" />
            ...
            <div className="container mx-auto px-4 md:px-6 relative z-10">
                <div className="flex flex-col items-center text-center max-w-4xl mx-auto">
                    ...
                    <motion.h1
                        ...
                        className="text-4xl md:text-5xl lg:text-7xl font-extrabold text-white leading-[1.1] mb-6 tracking-tight"
                    >
                        Elevating the <br />
                        <motion.span
                    ...
                    >
                        ...
                        <button className="bg-white/5 backdrop-blur-md border border-white/30 text-white px-6 md:px-10 py-3 md:py-4 rounded-full font-semibold text-sm md:text-base hover:bg-white/10 transition-all active:scale-95 w-full sm:w-auto">
                            Our Method
                        </button>
                    </motion.div>
